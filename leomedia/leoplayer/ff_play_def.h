...
#define FF_PLAY_EVENT (SDL_USEREVENT + 12)
#define FF_VOLUME_UP_EVENT (SDL_USEREVENT + 13)
#define FF_VOLUME_DOWN_EVENT (SDL_USEREVENT + 14)
#define FF_SEEKTO_EVENT (SDL_USEREVENT + 15)
#define FF_STOP_EVENT (SDL_USEREVENT + 16)
